...
public class DepartmentPage extends Login_PMS
{
    ...
    public void EditDepartment()
    {
    	...
    	WebElement edit=driver.findElement(By.xpath("html/body/div[1]/div/section[2]/form/div/div/div[2]/div/table/tbody/tr[4]/td[6]/a[1]"));
    	edit.click();
    	WebElement desc=driver.findElement(By.linkText("testdatadescription"));
